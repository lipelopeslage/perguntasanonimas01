module.exports = function(collection){
	return {
		...
		update: function(){
			var args = [].slice.call(arguments), objs = [], query, modifier, callback;
			callback = args.filter(function(arg){
				if(typeof arg == 'object') objs.push(arg);
				return typeof arg == 'function';
			})[0] || function(){};
			query = objs[0] || {};
			/*trata o segundo argumento como modificador usado na atualização*/
			modifier = objs[1] || null;
			try{
				/*atualiza a coleção de acordo com a query e modificador, 
				  e chama o callback passando o resultado*/
				collection.update(query, modifier, function(err, res){
					callback.call(this, res);
				})
			}
			catch(err){
